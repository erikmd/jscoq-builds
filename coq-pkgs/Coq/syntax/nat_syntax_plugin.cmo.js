...
c=d.caml_get_global_data(),m=a("nat_syntax_plugin"),f=c.Coqlib,l=c.Globnames,g=c.Bigint,e=c.Pp,k=c.Loc,v=c.Errors,u=c.Notation,w=c.CWarnings;b(c.Mltop[12],m);var
...
x(j){var
a=b(e[26],y),c=b(e[26],z),d=b(e[26],A),f=b(e[26],B),g=h(e[14],f,d),i=h(e[14],g,c);return h(e[14],i,a)}var
o=s(w[2],D,C,0,x);function
...
l=[0,a,F,b(e[1],E)];return b(v[8],l)}var
i=[248,G,d.caml_fresh_oo_id(0)];function
j(a){switch(a[0]){case
0:if(h(l[5],a[1][2],f[23]))return g[5];break;case
4:var
d=a[2];if(0===d[0]){var
c=a[3];if(c)if(!c[2])if(h(l[5],d[1][2],f[24])){var
e=j(c[1]);return b(g[9],e)}}break}throw i}function
q(a){try{var
